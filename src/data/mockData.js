...
export const FEATURED_REVIEWS = [
  {
    ...
    content: 'DeepSeek 的这个解析太透彻了，特别是关于国产大模型在垂直领域的应用案例，对我启发很大！以前一直觉得大模型落地难，现在有了新的思路。',
    videoId: 201,
    videoTitle: 'DeepSeek 深度解析：国产大模型应用'
  },
  {
    id: 2,
    user: '李娜',
    ...
    content: '一直觉得 Excel 很难，看了这个教程发现其实只要掌握几个核心 AI 插件，效率直接起飞。强烈推荐给每天都要处理表格的同事们！',
    videoId: 202,
    videoTitle: '高效办公：Excel 中的 AI 技巧'
  },
  {
    id: 3,
    user: '王强',
    ...
    content: '网络安全意识真的太重要了，讲师举的钓鱼邮件案例非常真实，以后在工作中一定会更加小心。这种必修课建议多来点。',
    videoId: 204,
    videoTitle: '网络安全基础意识'
  },
  {
    ...
    content: 'Midjourney 的进阶技巧讲得很细，特别是关于 prompt 的优化逻辑，试了一下效果惊人！感觉自己的创作瓶颈被打开了。',
    videoId: 205,
    videoTitle: 'AI 绘画工具 Midjourney 进阶'
  }
];
