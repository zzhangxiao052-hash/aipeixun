        ...
        <div className="flex-1 max-w-lg mx-8 hidden lg:block">
          <div className="relative group">
            <div className={`flex items-center rounded-lg overflow-hidden border transition-all ${
              isTransparent 
                ? 'bg-white/20 border-white/30 text-white focus-within:bg-white focus-within:text-gray-700' 
                : 'bg-gray-100 border-transparent focus-within:border-blue-300 focus-within:bg-white focus-within:shadow-md'
            }`}>

              <input 
                type="text" 
                placeholder="搜索课程、知识点或 AI 工具..." 
                className={`flex-1 px-3 py-2 bg-transparent outline-none text-sm placeholder-gray-400 ${
                  isTransparent ? 'text-white placeholder-gray-300 focus:text-gray-700' : 'text-gray-700'
                }`}
              />
              <button className={`px-4 py-2 transition-colors ${
                isTransparent ? 'text-gray-200 hover:bg-white/20' : 'text-gray-600 hover:bg-gray-200'
              }`}>
